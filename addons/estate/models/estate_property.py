...
class EstateProperty(models.Model):
    ...
    def _default_date_availability(self):
        return fields.Date.context_today(self) + relativedelta(days=7)
    ...
    closing_date = fields.Date("Closing Date", default=lambda self: self._default_closing_date())
        ...
        for prop in self:
            if (
                ...
                raise ValidationError(
                    "The offer price must be at least 90% of the expected selling price! "
